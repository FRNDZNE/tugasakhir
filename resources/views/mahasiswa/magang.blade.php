                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{-- modal batal magang --}}
                            @if (Auth::user()->mahasiswa->intern)
                                @if (Auth::user()->mahasiswa->intern->agency_id == $d->agency_id && Auth::user()->mahasiswa->intern->period_id == $d->period_id)
                                    <!-- Modal trigger button -->
                                    @php
                                        $batal = Auth::user()->mahasiswa->intern->id;
                                    @endphp
                                    <button
                                        type="button"
                                    ...
                                    >
                                        ...
                                        >
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Ingin Membatalkan Magang Di {{ $d->agency->name }} ?</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button
                                                        type="button"
